...
const translations: Translations = {
  ...
  web_development: { en: 'Web Development', so: 'Horumarinta Web-ka' },
  ui_ux: { en: 'UI/UX Design', so: 'Naqshadeynta UI/UX' },
  digital_marketing: { en: 'Digital Marketing', so: 'Suuqgeynta Dijitaalka' },
  data_science: { en: 'Data Science & AI', so: 'Sayniska Xogta & AI' },
  business: { en: 'Business Strategy', so: 'Istiraatiijiyadda Ganacsiga' },
  ...
  email_field: { en: 'Your Email (Email)', so: 'Iimaylkaaga (Email)' },
